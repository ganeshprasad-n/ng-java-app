#!/bin/bash
################################################################################
# Jenkins CI/CD Server Setup - Rocky/Alma/Fedora
#
# Purpose: Install Jenkins, Java, Maven, Git
# Tested on: Rocky Linux 9, Alma Linux 9, Fedora 42
...
# Check root
if [[ $EUID -ne 0 ]]; then
   echo "[ERROR] Run as root: sudo ./jenkins-setup-rhel.sh"
   exit 1
fi

echo "=============================================="
echo "Jenkins CI/CD Server Setup"
echo "Rocky Linux / Alma Linux / Fedora"
...
dnf install -y curl wget unzip vim net-tools
...
echo "  Java 11:  $(alternatives --list | grep java-11)"
echo "  Java 17:  $(alternatives --list | grep java-17)"
